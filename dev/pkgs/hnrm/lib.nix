...
, generic-data, generic-deriving, generic-lens, hxt, hxt-xpath
, intervals, json-schema, lens, MonadRandom, mtl, mtl-compat
, neat-interpolation, optparse-applicative, pretty-simple
, prettyprinter, protolude, random, recursion-schemes, refined
, regex, resourcet, src, stdenv, storable-endian, template-haskell
, text, transformers, typed-process, units, units-defs, unix
, unordered-containers, uuid, vcs-revision, vector, yaml
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    generic-aeson generic-data generic-deriving generic-lens hxt
